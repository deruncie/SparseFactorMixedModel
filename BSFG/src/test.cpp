...
// }
//
// SpMat make_chol_R2(const std::vector<R_matrix>& ZKZts, const VectorXd h2s, const double tol){  //std::vector<Map<MatrixXd> > ZKZts
...
//   load_R_matrices_list2(ZKZts_,ZKZts);
//
//   std::vector<SpMat> chol_R_list;
