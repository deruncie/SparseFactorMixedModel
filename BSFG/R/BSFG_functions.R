...
#'
#' The synthetic parameter can be pre-calculated using \ref{get_posterior_fun}, or if
#'
#' @param X either an array of posterior samples (either a parameter from \code{Posterior}, or
#'     an object generated by \ref{get_posterior_fun}), or the BSFG_state object with re-loaded Posterior
