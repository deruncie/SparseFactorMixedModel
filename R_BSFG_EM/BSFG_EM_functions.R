...
maximize_delta = function( delta,tauh,Lambda_prec,delta_1_shape,delta_1_rate,delta_2_shape,delta_2_rate,Lambda2 ) {
	# maximize delta and tauh parameters that control the magnitudes of higher
