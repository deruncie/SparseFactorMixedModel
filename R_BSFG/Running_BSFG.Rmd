...
# mean(rgamma(1e6,shape=2.1,rate=1/20))
# hist(rgamma(1e5,shape=3,rate=1),breaks=c(seq(0,10,length=100),Inf),xlim=c(0,10))
# hist(rt(1e5,df=1),breaks=c(-Inf,seq(-10,10,length=100),Inf),xlim=c(-10,10))
# hist(rt(1e5,df=3),breaks=c(-Inf,seq(-10,10,length=100),Inf),xlim=c(-10,10))
# hist(rt(1e5,df=10),breaks=c(-Inf,seq(-10,10,length=100),Inf),xlim=c(-10,10))
# hist(rt(1e5,df=100),breaks=c(-Inf,seq(-10,10,length=100),Inf),xlim=c(-10,10))
# hist(rt(1e5,df=1000),breaks=c(-Inf,seq(-10,10,length=100),Inf),xlim=c(-10,10))
```
