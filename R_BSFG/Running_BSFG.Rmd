...
maps = make_Missing_data_map(BSFG_state,50,0,T)
BSFG_state = set_Missing_data_map(BSFG_state,maps$Missing_data_map_list[[maps$map_results$iter[which(maps$map_results$total_kept_NAs ==0)[1]]]])
...
```{r}
n_samples = 200;  # how many samples to collect at once?
for(i  in 1:70) {
